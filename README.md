...
1. What is the purpose of using _sessions_?
    ...
    Sessions allows us access to data across requests as long as the user is authenticated

1. What does bcrypt do to help us store passwords in a secure manner.

    It will hash the password prior to storage.

1. What does bcrypt do to slow down attackers?

    It will hash a password multiple times based on the second optional parameter
